...
export const SEED_WORKERS: Worker[] = [
  // 1. Electrical
  {
    ...
    category: 'ELECTRICAL',
    services: ['srv-elec-1', 'srv-elec-2'],
    pincodes: ['110001', '110002', '110024', '110048', '110017'],
    gender: 'male',
    isAvailable: true,
  ...
  // 2. Appliance Repair
  {
    ...
    category: 'APPLIANCE',
    services: ['srv-app-1', 'srv-app-2', 'srv-app-3'],
    pincodes: ['110001', '110002', '110075', '110078', '110059'],
    gender: 'male',
    isAvailable: true,
  ...
  // 3. Electrical (Smart Home)
  {
    ...
    category: 'ELECTRICAL',
    services: ['srv-elec-1', 'srv-elec-3'],
    pincodes: ['201301', '201309', '110001', '110002', '110091'],
    gender: 'male',
    isAvailable: true,
  ...
  // 4. Plumbing
  {
    ...
    category: 'PLUMBING',
    services: ['srv-plumb-1', 'srv-plumb-2'],
    pincodes: ['560038', '560001', '110001', '110002', '110024'],
    gender: 'male',
    isAvailable: true,
  ...
  // 5. Carpentry
  {
    ...
    category: 'CARPENTRY',
    services: ['srv-carp-1', 'srv-carp-2'],
    pincodes: ['122002', '122018', '110001', '110002', '110024'],
    gender: 'male',
    isAvailable: true,
  ...
  // 6. Painting & Waterproofing
  {
    ...
    category: 'PAINTING',
    services: ['srv-paint-1'],
    pincodes: ['400053', '400058', '110001', '110002', '110024'],
    gender: 'male',
    isAvailable: true,
  ...
  // 7. Pest Control & Gardening
  {
    ...
    services: ['srv-pest-1'],
    pincodes: ['110085', '110034', '110001', '110002', '110024'],
    gender: 'male',
    isAvailable: true,
  ...
  // 8. Deep Cleaning & Housekeeping
  {
    ...
    category: 'CLEANING',
    services: ['srv-clean-1', 'srv-clean-2'],
    pincodes: ['110001', '110002', '110024', '110048', '110017'],
    gender: 'female',
    isAvailable: true,
  ...
  // 9. Emergency Electrician
  {
    ...
    category: 'ELECTRICAL',
    services: ['srv-elec-1', 'srv-elec-2', 'srv-elec-3'],
    pincodes: ['110001', '110002', '110024', '110003', '110006'],
    gender: 'male',
    isAvailable: true,
...
export const SEED_FEATURE_DEFINITIONS: import('../types').FeatureDefinition[] = [
  ...
  {
    key: 'workerReviewsVisibility',
    name: 'Worker Reviews & Ratings Visibility',
    description: 'Controls whether star ratings and review details are visible to Customers and Workers, or restricted to Admin/SuperAdmin only.',
    enabled: false,
    category: 'operations',
    environmentRestriction: 'all',
  },
...
export const SEED_SERVICE_REQUESTS: ServiceRequest[] = [
  {
    ...
    serviceName: 'Master Electrician Diagnostics & Wiring',
    selectedProblems: ['mcb_tripping', 'short_circuit'],
    otherProblemDetails: '',
    date: new Date(Date.now() + 86400000).toISOString().split('T')[0],
    slotStart: '09:00 AM',
    slotEnd: '11:00 AM',
    timeSlotDisplay: '09:00 AM - 11:00 AM',
    address: 'Flat 402, Block B, Green Park Apartments, Lajpat Nagar, Delhi - 110024',
    pincode: '110024',
    locality: 'Lajpat Nagar',
    additionalDetails: 'Main DB panel is located in the basement parking lot.',
    genderPreference: 'no_preference',
    priority: 'normal',
    amount: 299,
    paymentStatus: 'HELD_IN_ESCROW',
    requestStatus: 'OPEN',
    assignmentDeadline: new Date(Date.now() + 86400000 - 3600000).toISOString(),
  ...
  },
  {
    ...
    serviceId: 'srv-plumb-1',
    serviceName: 'Pipe Leakage & Tap Repair',
    selectedProblems: ['concealed_pipe_leak', 'washbasin_drain_block'],
    date: new Date(Date.now() + 86400000).toISOString().split('T')[0],
    slotStart: '11:00 AM',
    slotEnd: '01:00 PM',
    timeSlotDisplay: '11:00 AM - 01:00 PM',
    address: 'A-12, Sector 14, Dwarka, Delhi - 110078',
    pincode: '110078',
    locality: 'Dwarka',
    additionalDetails: 'Please call 10 minutes prior to arrival.',
    genderPreference: 'no_preference',
    priority: 'emergency',
    amount: 249,
    paymentStatus: 'HELD_IN_ESCROW',
